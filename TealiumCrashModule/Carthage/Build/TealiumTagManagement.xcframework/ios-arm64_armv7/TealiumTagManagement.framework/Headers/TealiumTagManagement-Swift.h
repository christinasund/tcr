...
#ifndef TEALIUMTAGMANAGEMENT_SWIFT_H
#define TEALIUMTAGMANAGEMENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TealiumTagManagement",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC20TealiumTagManagement22TagManagementWKWebView")
@interface TagManagementWKWebView : NSObject
...
@interface TagManagementWKWebView (SWIFT_EXTENSION(TealiumTagManagement)) <WKHTTPCookieStoreObserver>
...
/// \param cookieStore <code>WKHTTPCookieStore</code> instance
///
...
@interface TagManagementWKWebView (SWIFT_EXTENSION(TealiumTagManagement)) <WKNavigationDelegate>
